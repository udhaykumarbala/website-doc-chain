const ServiceHero = () => {
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="mt-8 text-3xl font-normal text-white sm:mt-12 sm:text-4xl lg:text-5xl xl:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-purple-500">Transform your vision.</span> Develop innovative solutions with our expert software services.</h2>
